...
const normalizeContactPhone = (rawPhone: string | null | undefined): string | null => {
  ...
  if (digits.startsWith("120363") || digits.length > 15) return null;

  let normalized = digits;
  // Bare Brazilian local number (DDD + 8/9 dígitos) → prefixa o DDI 55.
            ...
            <div className="p-8 flex flex-col items-center text-center border-b border-white/5 bg-gradient-to-b from-white/[0.02] to-transparent">
              ...
              <div className="flex gap-2 mt-6">
                ...
                <button
                  type="button"
                  onClick={() => {
                    const phone = selectedContact.telefone?.trim();
                    if (!phone) {
