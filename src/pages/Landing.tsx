...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans selection:bg-primary/30">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-white/5 bg-background/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-16 md:h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            <a href={whatsappLink} onClick={(e) => { trackEvent("whatsapp_click", { method: "whatsapp" }); }} target="_blank" rel="noreferrer" className="flex items-center gap-2 rounded-full bg-primary px-6 py-2.5 text-sm font-semibold text-primary-foreground hover:bg-primary/90 transition-all active:scale-95 shadow-[0_0_24px_rgba(245,158,11,0.2)] dark:shadow-[0_0_24px_rgba(245,158,11,0.1)]">
        ...
        {isMobileMenuOpen && (
          <div className="absolute top-[64px] left-0 w-full h-[calc(100vh-64px)] bg-background/95 backdrop-blur-xl flex flex-col px-6 py-8 md:hidden border-t border-white/5 animate-in slide-in-from-top-2 duration-200">
            ...
            <a href={whatsappLink} onClick={(e) => { trackEvent("whatsapp_click", { method: "whatsapp" }); setIsMobileMenuOpen(false); }} target="_blank" rel="noreferrer" className="flex justify-center items-center gap-2 rounded-full bg-primary px-6 py-4 text-base font-bold text-primary-foreground mt-auto mb-10 active:scale-95">
              Diagnóstico gratuito
              <MoveRight size={20} />
            </a>
          </div>
        ...
        <section className="relative overflow-hidden pt-16 pb-20 md:pt-24 md:pb-28 lg:pt-32 lg:pb-32">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
              <a href={whatsappLink} onClick={(e) => { trackEvent("whatsapp_click", { method: "whatsapp" }); }} target="_blank" rel="noreferrer" className="w-full sm:w-auto flex items-center justify-center gap-2 rounded-full bg-primary px-8 py-4 text-base font-bold text-primary-foreground hover:bg-primary/90 transition-all active:scale-95 shadow-[0_0_32px_rgba(245,158,11,0.25)]">
        ...
        <section id="servicos" className="py-16 md:py-24 bg-card/30 border-y border-white/5">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <a href={whatsappLink} onClick={(e) => { trackEvent("whatsapp_click", { method: "whatsapp" }); }} target="_blank" rel="noreferrer" className="block h-full">
      ...
      <a
        href={whatsappInfoLink} onClick={(e) => { trackEvent("whatsapp_click", { method: "whatsapp_info" }); }}
        target="_blank"
        rel="noreferrer"
