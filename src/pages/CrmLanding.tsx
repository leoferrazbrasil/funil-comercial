// Página do PRODUTO: Funil Comercial CRM (antiga landing do site, movida para
// /crm no reposicionamento de 2026-07-11). A home (/) agora é a página da
...
export default function CrmLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans selection:bg-primary/30">
        ...
        {isMobileMenuOpen && (
          <div className="absolute top-[64px] left-0 w-full h-[calc(100vh-64px)] bg-background/95 backdrop-blur-xl flex flex-col px-6 py-8 md:hidden border-t border-white/5 animate-in slide-in-from-top-2 duration-200">
            <nav className="flex flex-col gap-6 mb-8">
              ...
              <Link to="/" className="text-lg font-medium text-primary">Conhecer a Estrutura de Vendas</Link>
            </nav>
      ...
      {/* Faixa: vínculo com a marca-mãe */}
      <div className="bg-primary/10 border-b border-primary/20">
        <Link to="/" className="max-w-7xl mx-auto px-6 py-2.5 flex items-center justify-center gap-2 text-xs sm:text-sm text-primary hover:underline">
          <Layers size={14} className="shrink-0" />
          <span>O CRM é a camada de <strong>Conversão</strong> do Método Estrutura de Vendas — conheça a estrutura completa</span>
          <MoveRight size={14} className="shrink-0" />
        </Link>
      </div>
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden pt-16 pb-20 md:pt-24 md:pb-32 lg:pt-36 lg:pb-40">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10 text-center">
            ...
            <p className="mx-auto max-w-2xl text-base sm:text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed px-2 sm:px-0">
              O CRM desenhado para quem não tem tempo a perder. Acompanhe cada negociação, do WhatsApp ao fechamento, em um fluxo visual impecável.
            </p>
                      ...
                      <div className="flex-1 flex flex-col gap-3">
                        {[...Array(3 - i)].map((_, j) => (
                          <div key={j} className="bg-card p-4 rounded-xl border border-white/5 shadow-sm">
                            ...
                            <div className="text-xs text-muted-foreground mb-4">Orçamento enviado — aguardando retorno</div>
        ...
        <section id="problema" className="py-16 md:py-24 bg-card/30 border-y border-white/5 relative">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mb-12 md:mb-16 max-w-2xl">
              ...
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-6 leading-tight">O mercado não perdoa desorganização. Você perde por falta de processo.</h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-background p-6 md:p-8 rounded-3xl border border-white/5 hover:border-primary/30 transition-colors">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">Follow-ups esquecidos porque tudo depende de planilhas manuais ou lembretes no celular.</p>
              </div>
        ...
        <section id="solucao" className="py-16 md:py-24 relative overflow-hidden">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="text-center mb-20 max-w-3xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground">Cada etapa foi milimetricamente desenhada para reduzir o esforço operacional e maximizar o fechamento.</p>
            </div>
          ...
          <div className="mx-auto max-w-3xl px-6 lg:px-8">
            ...
            <div className="space-y-4">
              {[
                ...
                { q: "Posso testar antes de assinar?", a: "Sim, disponibilizamos uma conta de teste gratuita para você explorar as funcionalidades, criar oportunidades e simular a sua operação." },
                ...
                { q: "Meus dados estão seguros?", a: "Sim. Seus dados trafegam criptografados (TLS) e ficam armazenados com criptografia em repouso na infraestrutura do Supabase, com acesso isolado por conta — só você vê seus clientes e negociações." },
                { q: "Preciso de mais do que o CRM?", a: "Talvez. O CRM organiza quem já chega até você. Se o seu desafio também é SER ENCONTRADO (site, Google) ou ATRAIR clientes (anúncios), conheça a nossa Estrutura de Vendas completa na página inicial." }
              ].map((faq, i) => (
        ...
        <section className="py-16 md:py-24 lg:py-32 relative overflow-hidden bg-card border-t border-white/10">
          ...
          <div className="relative mx-auto max-w-4xl px-6 lg:px-8 text-center z-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-10 md:mb-12 max-w-2xl mx-auto">Crie sua conta de demonstração em 1 minuto e descubra como quem vende bem controla suas negociações.</p>
      ...
      <footer className="border-t border-white/10 bg-background py-10 md:py-12">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0">
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6">
            <Link to="/" className="text-xs md:text-sm text-muted-foreground hover:text-primary transition-colors">Início</Link>
