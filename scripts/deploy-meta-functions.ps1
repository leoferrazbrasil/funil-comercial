...
npx supabase@latest secrets set META_APP_ID=$APP_ID --project-ref juvwfxnlusrnvcarkrmc
npx supabase@latest secrets set META_APP_SECRET=$APP_SECRET --project-ref juvwfxnlusrnvcarkrmc

Write-Host "Fazendo o Deploy da Função de Autenticação (meta-auth)..." -ForegroundColor Cyan
npx supabase@latest functions deploy meta-auth --no-verify-jwt --project-ref juvwfxnlusrnvcarkrmc

Write-Host "Fazendo o Deploy da Função de Publicação (meta-publish)..." -ForegroundColor Cyan
npx supabase@latest functions deploy meta-publish --no-verify-jwt --project-ref juvwfxnlusrnvcarkrmc
